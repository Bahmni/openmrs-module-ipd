package org.bahmni.module.ipd.controller;

import org.bahmni.module.ipd.BaseIntegrationTest;
import org.bahmni.module.ipd.contract.ScheduleMedicationResponse;
import org.bahmni.module.ipd.model.Schedule;
import org.bahmni.module.ipd.service.ScheduleService;
...
public class ScheduleMedicationControllerIntegrationTest extends BaseIntegrationTest {
    ...
    public void shouldSaveMedicationSchedule() throws Exception {
        ...
        System.out.println("DB value ======== "+ savedSchedule.getVoided() + "===="+savedSchedule.getDateCreated() +"===="+savedSchedule.getCreator().getUuid() + "====="+savedSchedule.getUuid());
